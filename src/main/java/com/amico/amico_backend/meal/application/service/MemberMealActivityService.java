...
import com.amico.amico_backend.meal.api.dto.response.MemberMealActivityDailyChargeResponse;
import com.amico.amico_backend.meal.api.dto.response.MemberMealActivityDayDetailResponse;
import com.amico.amico_backend.meal.api.dto.response.MemberMealActivityDayPaymentResponse;
import com.amico.amico_backend.meal.api.dto.response.MemberMealActivityDayResponse;
import com.amico.amico_backend.meal.api.dto.response.MemberMealActivityMonthResponse;
import com.amico.amico_backend.meal.api.dto.response.MemberMealActivitySelectionResponse;
import com.amico.amico_backend.meal.api.dto.response.MemberMealActivitySlotDetailResponse;
import com.amico.amico_backend.meal.api.dto.response.MemberMealActivitySlotResponse;
import com.amico.amico_backend.meal.api.dto.response.MemberMealActivitySubscriptionResponse;
import com.amico.amico_backend.meal.api.dto.response.MemberMealActivitySummaryResponse;
...
import com.amico.amico_backend.meal.domain.model.MemberMealActivitySlotStatus;
    ...
    public MemberMealActivityMonthResponse getMonthlyActivity(
        ...
        MealParticipationEntity participation = participationRepository
                .findBySpaceIdAndMemberIdAndStatus(
                        spaceId,
                        memberId,
                        com.amico.amico_backend.meal.domain.model.MealParticipationStatus.ACTIVE)
                .orElse(null);
