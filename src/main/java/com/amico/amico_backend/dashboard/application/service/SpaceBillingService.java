...
import com.amico.amico_backend.dashboard.application.support.PrepaidBalanceBillingCalculator;
...
public class SpaceBillingService {
    ...
    private MemberPaymentLedgerRowResponse buildRow(
        ...
        if (MealPricingPolicy.usesSeparateMealBilling(space) && (isMess || hasMealParticipation)) {
            ...
            // meal-activity paidAmount to avoid double-amicog approved day payments.
