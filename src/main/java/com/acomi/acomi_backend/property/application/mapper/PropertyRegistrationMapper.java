...
public final class PropertyRegistrationMapper {
    ...
    public static PropertyRegistrationDetailResponse toDetail(PropertyRegistrationEntity entity) {
        return PropertyRegistrationDetailResponse.builder()
                ...
                .mobileNumber(entity.getMobileNumber())
                .alternateMobileNumber(entity.getAlternateMobileNumber())
                .additionalMobileNumber(entity.getAdditionalMobileNumber())
                ...
                .linkedOwnerUserId(entity.getLinkedOwnerUserId())
                .sharingNotes(entity.getSharingNotes())
                .foodIncludedListing(entity.getFoodIncludedListing())
                .genderPolicy(entity.getGenderPolicy())
                .unmappedAmenities(entity.getUnmappedAmenities())
