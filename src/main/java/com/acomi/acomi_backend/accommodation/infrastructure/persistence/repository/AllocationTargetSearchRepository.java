...
import com.acomi.acomi_backend.accommodation.infrastructure.persistence.projection.AllocationTargetSearchRow;
...
@Repository
public interface AllocationTargetSearchRepository extends JpaRepository<com.acomi.acomi_backend.accommodation.infrastructure.persistence.entity.BedEntity, UUID> {

    @Query("""
            SELECT new com.acomi.acomi_backend.accommodation.infrastructure.persistence.projection.AllocationTargetSearchRow(
                com.acomi.acomi_backend.occupancy.domain.model.AllocationTargetType.BED,
                b.id,
            ...
            WHERE b.isActive = true
              ...
              AND (:selectableOnly = false OR b.status = com.acomi.acomi_backend.accommodation.domain.model.AccommodationStatus.AVAILABLE)
              AND (
    ...
    @Query("""
            SELECT new com.acomi.acomi_backend.accommodation.infrastructure.persistence.projection.AllocationTargetSearchRow(
                com.acomi.acomi_backend.occupancy.domain.model.AllocationTargetType.UNIT,
                u.id,
                b.id,
                b.name,
                b.code,
            ...
            WHERE u.isActive = true
              ...
              AND (:selectableOnly = false OR u.status = com.acomi.acomi_backend.accommodation.domain.model.AccommodationStatus.AVAILABLE)
              AND (
                  :query IS NULL OR :query = ''
