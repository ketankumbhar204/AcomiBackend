...
public interface AccommodationLazyListRepository extends Repository<FloorEntity, UUID> {
    ...
    @Query("""
            SELECT new com.acomi.acomi_backend.accommodation.api.dto.response.FloorListItemResponse(
                f.id,
                f.name,
    ...
    @Query("""
            SELECT new com.acomi.acomi_backend.accommodation.api.dto.response.UnitListItemResponse(
                u.id,
                u.name,
    ...
    @Query("""
            SELECT new com.acomi.acomi_backend.accommodation.api.dto.response.RoomListItemResponse(
                r.id,
                r.name,
                r.roomType,
    ...
    @Query("""
            SELECT new com.acomi.acomi_backend.accommodation.api.dto.response.BedSpaceListItemResponse(
                b.id,
                b.bedNumber,
                b.status,
