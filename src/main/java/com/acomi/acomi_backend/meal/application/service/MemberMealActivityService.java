...
import com.acomi.acomi_backend.meal.api.dto.response.MemberMealActivityDailyChargeResponse;
import com.acomi.acomi_backend.meal.api.dto.response.MemberMealActivityDayDetailResponse;
import com.acomi.acomi_backend.meal.api.dto.response.MemberMealActivityDayPaymentResponse;
import com.acomi.acomi_backend.meal.api.dto.response.MemberMealActivityDayResponse;
import com.acomi.acomi_backend.meal.api.dto.response.MemberMealActivityMonthResponse;
import com.acomi.acomi_backend.meal.api.dto.response.MemberMealActivitySelectionResponse;
import com.acomi.acomi_backend.meal.api.dto.response.MemberMealActivitySlotDetailResponse;
import com.acomi.acomi_backend.meal.api.dto.response.MemberMealActivitySlotResponse;
import com.acomi.acomi_backend.meal.api.dto.response.MemberMealActivitySubscriptionResponse;
    ...
    public MemberMealActivityMonthResponse getMonthlyActivity(
        ...
        MealParticipationEntity participation = participationRepository
                .findBySpaceIdAndMemberIdAndStatus(
                        spaceId,
                        memberId,
                        com.acomi.acomi_backend.meal.domain.model.MealParticipationStatus.ACTIVE)
                .orElse(null);
