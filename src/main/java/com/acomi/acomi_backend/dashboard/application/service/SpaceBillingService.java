...
import com.acomi.acomi_backend.dashboard.api.dto.response.PrepaidBalanceSummaryResponse;
import com.acomi.acomi_backend.dashboard.application.support.MealLedgerContribution;
import com.acomi.acomi_backend.dashboard.application.support.OccupancyBillingCalculator;
import com.acomi.acomi_backend.dashboard.application.support.PayPerMealBillingCalculator;
import com.acomi.acomi_backend.dashboard.application.support.PrepaidBalanceBillingCalculator;
import com.acomi.acomi_backend.dashboard.application.support.SpacePaymentLedgerSupport;
...
public class SpaceBillingService {
    ...
    private MemberPaymentLedgerRowResponse buildRow(
        ...
        if (MealPricingPolicy.usesSeparateMealBilling(space) && (isMess || hasMealParticipation)) {
            ...
            // meal-activity paidAmount to avoid double-acomig approved day payments.
