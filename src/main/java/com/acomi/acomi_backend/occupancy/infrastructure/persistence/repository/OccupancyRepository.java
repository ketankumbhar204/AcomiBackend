...
public interface OccupancyRepository extends JpaRepository<OccupancyEntity, UUID> {
    ...
    @Query("""
            ...
            WHERE o.space.id = :spaceId
              ...
              AND o.status = com.acomi.acomi_backend.occupancy.domain.model.OccupancyStatus.ACTIVE
            """)
    ...
    @Query("""
            ...
            WHERE o.space.id = :spaceId
              AND o.member.id = :memberId
              AND o.status = com.acomi.acomi_backend.occupancy.domain.model.OccupancyStatus.RESERVED
            """)
    ...
    @Query("""
            ...
            WHERE o.bed.id = :bedId
              AND o.status IN (
                  com.acomi.acomi_backend.occupancy.domain.model.OccupancyStatus.ACTIVE,
                  com.acomi.acomi_backend.occupancy.domain.model.OccupancyStatus.RESERVED)
            """)
    ...
    @Query("""
            ...
            WHERE o.space.id = :spaceId
              AND o.status IN (
                  com.acomi.acomi_backend.occupancy.domain.model.OccupancyStatus.ACTIVE,
                  com.acomi.acomi_backend.occupancy.domain.model.OccupancyStatus.VACATED)
              AND (
